...
class StringUtilsTest {
    ...
    @Test
    void testReverseUsingAssertEquals(){
    ...
    @Test
    void testCapitalizeUsingAssertEquals(){
    ...
    @Test
    void testIsEmptyWithVariousInputsIncludingANullCheck(){
    ...
    @Test
    void testCountVowelsUsingAssertEquals(){
    ...
    @Test
    void UsingAssertAllToGroupMultipleRelatedAssertionsTogether(){
        assertAll(() -> assertEquals("olleh", stringUtils.reverse("hello")),
                  () -> assertEquals("avaJ", stringUtils.reverse("Java")),
                  () -> assertEquals("", stringUtils.reverse("")));
    }
    ...
    @Test
    void passingNullInputToMethodsThrowsIllegalArgumentException(){
