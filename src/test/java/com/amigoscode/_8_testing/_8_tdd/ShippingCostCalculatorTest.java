...
class ShippingCostCalculatorTest {
    ...
    @Test
    void domesticShippingCostCalculationTest(){
        var actual = calculator.calculate(10.0, "domestic");
    ...
    @Test
    void InternationalShippingCostCalculationTest(){
        var actual = calculator.calculate(10.0, "international");
        assertThat(actual).isEqualTo(30.00);
    }
    ...
    @Test
    void negativeWeightThrowsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class,
                () -> calculator.calculate(-1.00, "domestic"));
    }
    ...
    @Test
    void ifWeightIsZeroResultShouldBeFreeShipping(){

        var actual = calculator.calculate(0, "domestic");
        assertThat(actual).isEqualTo(0.0);

        var actual2 = calculator.calculate(0,"international");
    ...
    @Test
    void heavyPackageSurchargeForWeightMoreThanFiftyKg(){
        var actual = calculator.calculate(60, "domestic");
        assertThat(actual).isEqualTo(60.00);

        var actual2 = calculator.calculate(60,"international");
        assertThat(actual2).isEqualTo(130.00);
    }
