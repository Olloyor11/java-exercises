...
public class ClassCastProblem {
    ...
    public static void main(String[] args) {
       ...
       try {
        ...
        //a) Because we try to cast integer to class java.lang.String and it is the main reason that happens;
        //b) if we write List<String> our problem would be caught at compile time;
        //c) if we use generics we would catch error at compile time
