...
public class GenericMethods {
    ...
    public static void main(String[] args) {
        ...
        String[] str = {"Aziz", "Rustam", null, "Bahodir", null, "Hojimurod", null, null};
        Integer[] nums = {1,23,35,357,458,456,345,23,12};
        printArray(str);
        printArray(nums);
        ...
        System.out.println(contains(nums, 458));
        ...
        printArray(str);
        //while I have created a generic method as I have made type as T not a specific type
        // the program reads it from method's argument and while I am going to use this method
        // I can use without mentioning the type parameter!
