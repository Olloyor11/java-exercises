 ...
 *   1. Static method reference:           ClassName::ae
...
public class MethodReferences {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(upperCaser.apply("hello"));
        ...
        System.out.println(getLength.apply("Hello").equals(lengthGetter.apply("Hello")));
