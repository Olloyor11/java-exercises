...
public class EventProcessor {
    ...
    public static void main(String[] args) {
        ...
        addListener("onClick", data -> System.out.println("Button clicked! Data: " + data));
        addListener("onClick", data -> System.out.println("Logging click event: " + data));
        addListener("onClick", data -> System.out.println("Analytics: tracking click - " + data));
        ...
        //  "Hovering over: <data>"
        addListener("onHover", data -> System.out.println("Hovering over: " + data));
