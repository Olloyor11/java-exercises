...
public class TreeMapExercises {
    ...
    public static void main(String[] args) {
        ...
        NavigableMap<String, Double> desProduct = productPrices.descendingMap();
        for (Map.Entry<String, Double> dec : desProduct.entrySet())
        System.out.println(dec.getKey() + ": " + dec.getValue() + " $");
